...
public class MainUser implements UserDetails {
    ...
    // Esta clase nos permite identificar autoridades y restringir acciones
    ...
    public static MainUser build(Usuario usuario) {
        ...
        return new MainUser(usuario.getId(), usuario.getNombre(), usuario.getEmail(), usuario.getPassword(),
                authorities);
    }
